...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-4 order-md-2 mb-4">
      ...
      <ul class="list-group mb-3" id="cartContainer">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" novalidate>
        ...
        <div class="d-block my-3">
          ...
          <div class="custom-control custom-radio">
            <input id="paypal" name="paymentMethod" value="nagad" type="radio" class="custom-control-input" required>
            <label class="custom-control-label" for="paypal">Nagad</label>
          </div>
        </div>
        <div class="row" id="trxContainer">
          <div class="col-md-6 mb-3">
            <label for="trxid">Transaction ID</label>
            <input type="text" class="form-control" id="trxid" placeholder="" required>
